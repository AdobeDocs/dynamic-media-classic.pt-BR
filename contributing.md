...
Agradecemos sua escolha em colaborar com a documentação da Adobe Dynamic Media Classic. O Adobe agradece as contribuições de conteúdo de toda a comunidade de leitores e de outros funcionários da Adobe.
...
Embora a Adobe seja bem-vinda a qualquer contribuição para aprimorar a documentação, certifique-se de que a contribuição siga determinadas diretrizes e normas, quando possível. Consulte as [Diretrizes de contribuição na documentação do Adobe Dynamic Media Classic](guidelines.md) para obter mais informações.
