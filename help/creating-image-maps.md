...
1. Siga um destes procedimentos:
   ...
   * Se estiver trabalhando com uma imagem na Exibição de grade ou na Exibição de lista, na lista suspensa Editar selecione **[!UICONTROL Image Map]**. Ou, abra-o na Exibição de detalhes e selecione **[!UICONTROL Image Map]** acima da imagem.
   * Se estiver trabalhando com um SpinSet na Exibição de Grade ou na Exibição de Lista, selecione **[!UICONTROL Edit]**. Ou, abra-o na Exibição de detalhes e selecione **[!UICONTROL Edit]**. Selecione um ativo de imagem e, em seguida, selecione **[!UICONTROL Image Map]**.
   * Se você estiver trabalhando com um eCatalog, na Exibição de Grade, Exibição de Lista, Exibição de Detalhes, selecione **[!UICONTROL Edit]**. Selecione o **[!UICONTROL Map Pages]** guia .
...
1. Desenhar um mapa de imagem retangular ou polígono (de vários lados):
   ...
   * **Mapa poligonal** - Selecione a ferramenta Mapa de imagem do polígono e selecione pontos no perímetro da área da imagem que deseja delimitar. Use o controle deslizante de densidade do polígono para variar a densidade do ponto no polígono. A densidade original é lembrada se você selecionar outros mapas. Se qualquer ponto for adicionado, excluído ou movido no polígono, a densidade original será perdida e o controle deslizante será redefinido para seu valor máximo.
...
1. Insira um nome para o Mapa de imagem, se desejado, na lista Mapa de imagem. Depois de desenhar um Mapa de imagem, o Adobe Dynamic Media Classic atribui um nome a ele.
   ...
   Para criar o nome, o Adobe Dynamic Media Classic anexa um número sequencial ao nome da página de imagem ou eCatalog com a qual você está trabalhando. Você pode inserir um nome de sua escolha.
...
1. Para exibir o texto de sobreposição quando os usuários moverem o ponteiro sobre o Mapa de imagem, insira o texto na lista Mapa de imagem. Na lista Mapa de imagem, selecione o **[!UICONTROL Show]** e selecione **[!UICONTROL Rollover Text]**. Em seguida, insira o texto que deseja que os usuários vejam na tela. Você pode gravar o texto em um processador de texto e copiá-lo no campo de texto Sobreposição .
...
1. (Opcional) Siga um destes procedimentos:
   ...
   * Para excluir um Mapa de imagem ou vértice de polígono, selecione uma forma na imagem e selecione **[!UICONTROL Delete]**. Ou, para um eCatalog, na guia Páginas do pedido, selecione **[!UICONTROL Clear Maps]** para remover mapas de imagem de todas as páginas.
...
Para alterar a posição, a forma e o tamanho de um Mapa de imagem, selecione o botão Mapa de imagem . Em seguida, selecione a **[!UICONTROL Pan]** e siga estas instruções:

* **Alterar posição** - Mova o ponteiro perto da borda do Mapa de imagem, mas não acima dela. Ao ver o ícone de seta de quatro pontas, arraste o mapa para um novo local.

* **Alterar o tamanho e a forma** - A forma como você altera a forma e o tamanho de um Mapa de imagem depende de você estar trabalhando com um Mapa de imagem retangular ou polígono:
...
1. (Opcional) Selecione **[!UICONTROL Generate]** para visualizar os dados resultantes com base no tipo de arquivo que deseja criar. Selecionar **[!UICONTROL Close]** para retornar à caixa de diálogo Fazer upload de metadados .
...
Você pode copiar mapas de imagem de uma imagem ou de uma página de catálogo eletrônico para outra. Use **[!UICONTROL Copy Image Map]** para começar a criá-los. Também é possível copiar Mapas de imagem para recriá-los em imagens ou páginas que compartilham layout ou estrutura de mapeamento.
...
Por padrão, o modelo de URL inclui um manipulador JavaScript do Adobe Dynamic Media Classic proprietário chamado `loadProduct` que abre uma nova janela com o destino do URL. No entanto, você pode usar qualquer código JavaScript para substituir esse manipulador JavaScript ou usar um dos seguintes manipuladores do Adobe Dynamic Media Classic:
...
* `loadProductPW` - Exibe o destino do URL especificado na coluna URL na janela principal (a página que abriu o atual). A janela atual permanece aberta, mas a janela pai é alterada para exibir o destino do URL.
   ...
   >[!NOTE]
   >
   >O manipulador `loadProductPW` não suporta visualizadores DHTML e HTML5.
...
1. Insira o código JavaScript e o URL completo (com a parte variável substituída por sinais de dólar) [$$]). Você pode colar o código clicando com o botão direito do mouse e escolhendo **[!UICONTROL Paste]**.
1. Selecionar **[!UICONTROL Save]**.
...
Você pode selecionar a variável **[!UICONTROL Show]** e escolha **[!UICONTROL Other Actions]** para acionar ações diferentes de sobreposição de texto e de inicializações de página da Web. Quando o usuário move o ponteiro sobre um Mapa de imagem, você pode iniciar uma ação. Essas ações são atributos definidos para mapas de imagem do lado do cliente pelas especificações do HTML World Wide Web Consortium. Eles incluem:
...
1. Na tela do Editor de mapa (imagens e Conjuntos de rotação) ou na guia Páginas de mapa da tela Catálogo eletrônico (eCatalogs), selecione o **[!UICONTROL Show]** e selecione **[!UICONTROL Other Actions]**.
1. Usando a sintaxe especificada pelas especificações do HTML World Wide Web Consortium, adicione os atributos suportados na coluna Outras ações da lista Mapa de imagem.
1. Selecionar **[!UICONTROL Save]**.

Selecione o **[!UICONTROL Show]** e selecione **[!UICONTROL Both]** se você quiser que um Mapa de imagem tenha um texto sobreposto e uma ação .
...
No Adobe Acrobat ou Adobe InDesign, crie referências de hiperlink onde deseja que os Mapas de imagem apareçam e especifique os locais do URL para o mapa de imagem. Selecionar a opção Extrair links ao carregar o arquivo PDF no Adobe Dynamic Media Classic converte automaticamente os links para os Mapas de imagem.
...
1. Na caixa de diálogo Novo hiperlink , na **[!UICONTROL Link To]** escolha **[!UICONTROL URL]**.
...
1. Salve o arquivo.
1. Carregue o PDF para o Adobe Dynamic Media Classic e selecione Extrair links nas Opções do PDF.
