...
>[!NOTE]
>
>Os usuários do Media Portal que têm permissão para alterar senhas podem fazer isso selecionando **[!UICONTROL Setup]** > **[!UICONTROL Personal Setup]** e alterando senhas na tela Configuração Pessoal.
