...
![O eCatalog como ele é exibido aos usuários. A) Página de abertura do eCatalog. B)eCatalog na página 2.](/help/assets/ec_cat_viewer_popup.png)
...
Consulte [Gerenciar conteúdo do Painel de Informações em eCatalogs](/help/info-panel-content-ecatalog.md).
