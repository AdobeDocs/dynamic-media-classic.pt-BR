...
Clique em **[!UICONTROL Save]**, insira um nome para seu eCatalog, escolha uma pasta do Dynamic Media Classic para armazená-lo e clique em **[!UICONTROL Save]**. Sempre que alterar a ordem de página ou editar seu eCatalog, salve as alterações clicando em **[!UICONTROL Save]**.
...
Para criar uma predefinição do visualizador de eCatalog, na barra Navegação global, clique em **[!UICONTROL Setup]** e escolha **[!UICONTROL Viewer Presets]**. Em seguida, clique em **[!UICONTROL Add]**, escolha uma plataforma e, em seguida, clique em **[!UICONTROL eCatalog > Viewer]**.
...
**5. Visualização de eCatálogos no eCatalog Viewer**
