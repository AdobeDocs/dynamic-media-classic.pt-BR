...
Para informar ao Adobe Analytics quais informações você deseja incluir nos relatórios do Adobe Analytics, acesse a tela Configuração do Adobe Analytics. Depois de configurar os relatórios, essa tela lista, para cada evento do visualizador sobre o qual você deseja obter informações, uma variável correspondente do Adobe Analytics e uma variável do Dynamic Media Classic. Essas combinações de variáveis eventos do visualizador - variável do Adobe Analytics - Dynamic Media Classic determinam quais informações são reportadas.
...
>[!NOTE]
>
>Sempre que alterar as configurações do Relatório do Analytics no Adobe Analytics, certifique-se de fazer logon novamente no Adobe Analytics a partir do Adobe Dynamic Media Classic, salvar novamente as configurações do Adobe Analytics e publicar novamente.
...
1. Clique em **Salvar**.
   ...
   Após clicar em Salvar, o evento do visualizador, sua variável Adobe Analytics e sua variável Dynamic Media Classic são listados na tela Configuração do Adobe Analytics.
...
| evento do visualizador | Suporte e visualizadores do HTML5 Viewer Platform | Descrição |
|--- |--- |--- |
...
| JOGAR | **X** (Vídeo) | Em visualizadores de vídeo, quando um usuário clica em Reproduzir para start reproduzindo um vídeo.<br><br>**Observação:**Se você estiver usando o relatórios de vídeo baseado em pulsação do Analytics, não será necessário mapear nenhuma variável para esse evento do visualizador ao configurar o Adobe Analytics no Dynamic Media Classic. O Video Heartbeat funciona com visualizadores Dynamic Media Classic HTML5 e MixedMedia prontos para uso. O player de vídeo gera dados de rastreamento para exibição nos Relatórios de vídeo da Analytics. Consulte[Ativação dos relatórios](enabling-analytics-video-reports.md)de vídeo do Adobe Analytics. |
...
Para cada evento do visualizador na tela Configuração do Adobe Analytics, escolha uma variável do Adobe Analytics e uma variável *do* Dynamic Media Classic. As variáveis do Dynamic Media Classic representam dados que você pode obter para um relatório. Por exemplo, a variável listas palavras-chave usadas em pesquisas do eCatalog. `searchTerm`
...
* **Ativando** Clique em **[!UICONTROL Enable]** para ativar ou **[!UICONTROL Disable]** para desativar um evento do visualizador selecionado.

* **Edição** Selecione um evento do visualizador e clique no botão **[!UICONTROL View/Edit]** Variáveis cinza. Nas listas suspensas Variável do Dynamic Media Classic e Variável do Adobe Analytics, escolha uma variável diferente de cada lista respectiva. Para obter mais informações, consulte Atribuindo variáveis do Adobe Analytics a eventos e variáveis do visualizador Dynamic Media Classic.

* **Excluindo** Selecione um evento do visualizador e clique no botão **[!UICONTROL View/Edit]** Variáveis cinza. Clique em **[!UICONTROL Delete]**.
