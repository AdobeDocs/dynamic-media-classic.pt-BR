...
Para aproveitar ao máximo os recursos de Zoom do Adobe Dynamic Media Classic, prepare os arquivos de imagem de zoom antes de carregá-los:

* **Tamanho da imagem**  - O Adobe Dynamic Media Classic recomenda o uso de arquivos de imagens que têm, no mínimo, 2000 pixels no tamanho mais longo. Dessa forma, as imagens podem ser claramente vistas quando os usuários as ampliam.
