...
1. Comece a criar seu eCatalog com uma destas técnicas:
   ...
   **Selecione os arquivos** primeiro. No painel Procurar, selecione os arquivos e clique em Criar > Catálogos eletrônicos.

   **Comece na** tela Catálogo eletrônicoClique em Criar > Catálogos eletrônicos. Selecione uma pasta na Biblioteca de ativos e arraste os arquivos da pasta até a guia Páginas de pedidos da página eCatalog.

   ***nota**: Para exibir os itens na Biblioteca de ativos por nome, em vez de miniatura, selecione a opção Nome para a Exibição da biblioteca de ativos padrão na Configuração pessoal. *

1. Selecione um layout geral para seu eCatalog. Clique no botão 1 Para cima para páginas únicas, no botão 2 Para cima para páginas duplas ou no botão Personalizado para páginas espelhadas com mais de duas páginas. A caixa de diálogo Alterar layout do catálogo eletrônico é exibida. Selecione as opções de Todas as páginas espelhadas e clique em **OK**.
1. Opcionalmente, altere o layout de páginas individuais ou de páginas espelhadas clicando nelas e escolhendo o botão 1 acima, 2 acima ou Personalizado. A caixa de diálogo Alterar layout do catálogo eletrônico é exibida. Selecione as opções de Spreads selecionados e clique em **OK**.
1. Reorganize as páginas conforme necessário com uma dessas técnicas:

   **** ArrastarArraste uma página ou uma página espelhada para um novo local. A barra vertical mostra onde a página está sendo movida.

   **Botão Mover paraSelecione uma página ou página espelhada, clique no botão Mover para e escolha a página no menu que você deseja que sua página apareça antes.** 
...
1. Clique em **Salvar**.
   ...
   Você pode visualizar seu eCatalog, depois de salvá-lo, clicando em **Preview**.
...
**Para editar um catálogo eletrônico**

1. Clique no botão **Editar** de sobreposição do Catálogo eletrônico.
...
Para importar o campo User Data em um arquivo delimitado por tabulação, inclua o campo userdata:
