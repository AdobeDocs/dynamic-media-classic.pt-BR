...
1. Se desejar especificar permissões de acesso agora, selecione a opção **[!UICONTROL Asset Access Permissions]** e especifique as opções desejadas.
...
1. Se desejar escolher quais Predefinições de imagem estão disponíveis para o grupo, selecione o **[!UICONTROL Image Preset Access Permissions]** e selecione Predefinições de imagem que o grupo pode usar.
...
1. Na página da lista Grupos, execute um dos seguintes procedimentos:
   ...
   * Para adicionar um grupo e especificar permissões, selecione **[!UICONTROL Add]**. Na caixa de diálogo Adicionar grupo , digite um nome para o grupo e selecione **[!UICONTROL Add Group]** e adicionar usuários ao grupo.
   * Para editar as permissões de um grupo, selecione o grupo e depois selecione **[!UICONTROL Edit]**.

1. Na caixa de diálogo Adicionar grupo ou Editar grupo , selecione o **[!UICONTROL Asset Access Permissions]** guia . O lado direito da guia oferece caixas para estabelecer permissões de leitura, gravação e exclusão para pastas e ativos. Você pode expandir e recolher pastas e subpastas no painel esquerdo.
...
1. Na página da lista Grupos, execute um dos seguintes procedimentos:
   ...
   * Para adicionar um grupo e especificar quais Predefinições de imagem estão disponíveis para ele, selecione **[!UICONTROL Add]**. Na caixa de diálogo Adicionar grupo , digite um nome para o grupo e selecione **[!UICONTROL Add Group]** e adicionar usuários ao grupo.
   * Para editar as opções de Predefinição de imagem de um grupo, selecione o grupo e depois selecione **[!UICONTROL Edit]**.

1. Na caixa de diálogo Adicionar grupo ou Editar grupo , selecione o **[!UICONTROL Image Preset Access Permissions]** guia .
