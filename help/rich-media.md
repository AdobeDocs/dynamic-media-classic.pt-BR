...
O Dynamic Media Classic oferta várias ferramentas para criar rich media. Você cria esses tipos de mídia avançada:
...
* **Públicos alvos** de zoomPermitem que os clientes aumentem, diminuam o zoom e deslocem imagens usando os visualizadores configuráveis que vêm com o Dynamic Media Classic. Os clientes podem visualização rápida e interativamente detalhes de produtos de alta resolução. Consulte Start [rápido: Zoom](/help/quick-start-zoom.md).
