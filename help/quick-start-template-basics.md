...
description: Uma introdução e o Início rápido para as noções básicas sobre modelo para ajudá-lo a ativar e executar rapidamente no Adobe Dynamic Media Classic.
