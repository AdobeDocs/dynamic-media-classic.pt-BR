...
**Como escolher um perfil de cor**

Escolha uma opção Perfil de cor para selecionar um espaço de cor para a imagem:

* **Converter em sRGB** converte em sRGB (Padrão Vermelho Verde Azul). sRGB é o espaço de cores recomendado para exibir imagens em páginas da Web.
...
|--- |--- |
| Valor | Controla a quantidade de contraste que é aplicada aos pixels da borda.<br><br>Pense nisso como a intensidade do efeito. A principal diferença entre os valores de quantidade de máscara de nitidez na SPS e os valores de quantidade no Adobe Photoshop é que o Photoshop tem um intervalo de quantidade de 1% a 500%. Enquanto, na SPS, o intervalo de valores é de 0,0 a 5,0. Um valor de 5,0 na SPS é o equivalente bruto de 500% no Photoshop; um valor de 0,9 é o equivalente a 90%, e assim por diante. |
...
Consulte também [Compartilhamento de imagens no Scene7 Publishing System e no Image Server](https://marketing.adobe.com/resources/help/en_US/s7/sharpening/s7_sharpening_images.pdf).
