...
Essas opções estão na página Upload na guia **[!UICONTROL Imaging Edit Options]** cabeçalho.

## Recortar espaço em branco de imagens

Para cortar automaticamente pixels de espaço em branco de uma imagem, na caixa de diálogo Upload Job Options , selecione **[!UICONTROL Crop Options]**. No **[!UICONTROL Crop]** lista suspensa, escolha **[!UICONTROL Trim]**. Em seguida, escolha estas opções:

* **[!UICONTROL Trim Away Based On]** - Nessa lista suspensa, escolha entre cortar com base na cor ou na transparência:

   * **[!UICONTROL Color]** - Escolha o **[!UICONTROL Color]** opção. Então, do **[!UICONTROL Corner]** na lista suspensa, selecione o canto da imagem com a cor que melhor representa a cor do espaço em branco que deseja recortar.
