...
Na área **[!UICONTROL General Setting]**, escolha se deseja gerar mapas de site de vídeo, feeds mRSS ou ambos. Na área **[!UICONTROL Generation Settings]**, mapeie campos de metadados para campos de entrada.
