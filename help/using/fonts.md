...
Você pode alterar o nome da ID de uma fonte e suas informações de tipo. A edição de um arquivo de fonte pode ser útil para pesquisas e para facilitar a identificação das fontes.
...
* **[!UICONTROL Font Type]**: As opções são TrueType e Adobe Type 1. Se você chamar essas fontes por outro nome, poderá inserir os nomes.
