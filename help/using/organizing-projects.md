...
Depois de criar uma pasta de projeto, você pode colocar ativos nela. Assets em um projeto são indicadores para a pasta Biblioteca de ativos na qual os ativos são armazenados. Você pode colocar um ativo em mais de um projeto. Por exemplo, uma imagem de uma camisa pode ser colocada nas pastas do projeto &quot;Camisas&quot; e &quot;Coleção de outono&quot;.
...
Para exibir, excluir e renomear uma pasta Projeto, use um dos seguintes métodos:

* **Conteúdo de navegação**: selecione o nome da pasta na Biblioteca de ativos. Seus ativos aparecem no painel Procurar.

* **Excluindo pastas do projeto**: selecione a pasta Projeto e selecione **[!UICONTROL Remove Project]**. A remoção de ativos de uma pasta do Projeto não os exclui do Adobe Dynamic Media Classic; os ativos permanecem em suas pastas de armazenamento originais.
