...
* **Conjuntos de mídias mistas**: forneça uma combinação de conjuntos de imagens, Conjuntos de rotação, conjuntos de amostras, Destinos de zoom, vídeo e áudio em uma apresentação. Para separar vídeos de imagens, é possível configurar conjuntos de mídias mistas com guias. Para fornecer aos usuários uma exibição multimídia completa de seus produtos ou serviços, você também pode especificar onde e como exibir amostras e Destinos de zoom.
...
* **Noções básicas do modelo**: crie modelos orientados por dados que combinam fontes, imagens e elementos gráficos para monogramação, personalização online e promoções. Por exemplo, coloque gráficos promocionais em camadas nas imagens do produto ou personalize camisetas ou canecas de café com os nomes dos clientes. Os clientes podem ver seus nomes em mensagens de email ou imprimir folhetos enviados a eles.
Consulte [Início Rápido: Noções Básicas Sobre Modelos](/help/using/quick-start-template-basics.md).

* **Metas de zoom**: permitir que os clientes ampliem, reduzam e desloquem imagens usando os visualizadores configuráveis fornecidos com o Adobe Dynamic Media Classic. Os clientes podem visualizar detalhes de produtos de alta resolução de maneira rápida e interativa.
