...
1. Vá para **[!UICONTROL Publish]** > **[!UICONTROL Submit Publish]** para executar uma publicação do Servidor de imagens.
...
| quadro | A página ou páginas referenciadas em um Conjunto de imagens. |
