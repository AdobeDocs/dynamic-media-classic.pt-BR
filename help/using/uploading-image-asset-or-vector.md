...
Solicite uma *chave de segredo compartilhado* por [usando a Admin Console para criar um caso de suporte](https://helpx.adobe.com/br/business/enterprise.html). No caso de suporte técnico, solicite uma chave de segredo compartilhado.
