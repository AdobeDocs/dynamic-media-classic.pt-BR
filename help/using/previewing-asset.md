...
Se estiver visualizando um ativo de modelo com camadas de parâmetros, você poderá alterar parâmetros ou alterar a Predefinição de imagem. Como as alterações são aplicadas imediatamente, é possível exibir os resultados na mesma janela de Pré-visualização.
...
Para uma determinada plataforma de visualizador, a janela Lista de visualizadores exibe os dispositivos, como tablets e smartphones, para os quais um visualizador está disponível.
...
1. (Opcional) Siga qualquer um destes procedimentos:
   ...
   * Na janela Lista de Visualizadores, na coluna Ações da tabela, selecione **[!UICONTROL Embed Code]**.
     ...
     Quando você seleciona **[!UICONTROL Embed Code]**, a janela Código Incorporado é aberta, onde você pode examinar o código do visualizador. Não é possível editar o código na janela. Você também pode copiar o código para a área de transferência para poder colá-lo em suas páginas da Web.
...
Para determinar como a imagem é exibida quando entregue dinamicamente ao seu site ou aplicativo em tamanhos diferentes, é possível visualizar um ativo de imagem com base em sua Predefinição de imagem.
...
1. (Opcional) Na janela Lista de Predefinições de Imagem, na lista suspensa **[!UICONTROL URL Encoding for Copy URL Generation]** na parte inferior, selecione a Codificação de URL.
