...
* [Como a Adobe Dynamic Media Classic oferece suporte para SEO](/help/using/assets/s7_seo.pdf): a Adobe Dynamic Media Classic otimiza imagens para que os mecanismos de pesquisa aumentem o tráfego para o seu site. Este PDF fornece o plano de fundo e a orientação de implementação para alcançar esse resultado.
...
* [Práticas recomendadas para fornecer experiências interativas com o Adobe Dynamic Media Classic](https://seminars.adobeconnect.com/p7wb8ej3u6d/): este webinário ensina como importar e exportar conteúdo com o Adobe Dynamic Media Classic. Saiba como configurar predefinições de imagem para obter o desempenho e a experiência ideais. Você também aprenderá sobre as Predefinições do visualizador e as configurações de armazenamento em cache.
