...
>
>No canto superior esquerdo da página de CRXDE Lite, selecione **[!UICONTROL Save All]**.
>
...
Na barra Navegação global, selecione **[!UICONTROL Upload]** para começar a carregar arquivos PDF ou imagens para seu eCatalog. Você pode fazer upload de arquivos do seu desktop ou por meio do FTP. O FTP é recomendado se você estiver fazendo upload de muitos arquivos ou de arquivos com mais de 100 MB.

Em Opções de PDF, a tela Upload fornece opções para fazer upload de arquivos PDF na resolução adequada e no espaço de cores correto. Recomenda-se uma resolução de 150 pixels por polegada. Você pode selecionar a opção **[!UICONTROL Auto-Generate eCatalog]** para criar um eCatalog ao carregar um arquivo PDF.
...
## 6. eCatalog do Publish e PDF associados
...
Depois de marcar seu eCatalog e PDF para publicação no painel Procurar, selecione o botão Publish na barra Navegação global para iniciar uma publicação. Na página Publicação, selecione **[!UICONTROL Submit Publish]**.

Consulte [eCatalogs do Publish e PDF associados](publishing-ecatalogs-associated-pdfs.md#publishing-ecatalogs-and-associated-pdfs).
