...
Ao criar um Conjunto de ofertas, a variável **[!UICONTROL Publish after a save]** opção afeta os membros set e set das seguintes maneiras:
...
1. Ao concluir, próximo ao canto inferior direito da página, verifique se **[!UICONTROL Publish after a save*]** está selecionada (padrão).
1. Selecionar **[!UICONTROL Close]**, digite um nome para o Conjunto de ofertas e selecione **[!UICONTROL Save]**.

Antes de fechar a página Conjunto de ofertas do Test&amp;Target, envie o Conjunto de ofertas para o Adobe Target Standard/Premium. Consulte [Encaminhar conjuntos de ofertas para o Test&amp;Target](pushing-offer-sets-target.md#pushing_offer_sets_to_target).
...
1. Depois de concluir a criação de ofertas para o Conjunto de ofertas e escolher Predefinições de imagem para imagens diferentes, verifique se **[!UICONTROL Publish after a save]** está selecionada (padrão).
1. Selecionar **[!UICONTROL Save]** e digite um nome para o Conjunto de ofertas e selecione **[!UICONTROL Save]**.
...
1. Para editar um Conjunto de ofertas, exiba o Conjunto de ofertas na Exibição em grade ou em lista e selecione seu **[!UICONTROL Edit]** botão de rolagem.
