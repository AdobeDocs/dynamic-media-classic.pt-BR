...
Os metadados são úteis em pesquisas e na organização de ativos somente se forem inseridos corretamente nos campos de metadados. Para inserir metadados corretamente e garantir que todos os campos de metadados necessários contenham metadados, é possível criar predefinições de metadados. Uma *predefinição de metadados* é um conjunto predefinido de entradas de metadados. Em vez de inserir metadados manualmente, os usuários podem, na Exibição de Detalhes, escolher uma predefinição de metadados para preencher campos de metadados com informações predefinidas.
