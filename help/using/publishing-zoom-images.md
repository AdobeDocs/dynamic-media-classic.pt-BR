...
As imagens devem ser marcadas para publicação para que sejam copiadas para os Servidores de Imagem do Dynamic Media. Você pode marcar suas imagens para publicação no painel Procurar selecionando o ícone **[!UICONTROL Mark for Publish]**. Você também pode marcar imagens para publicação ao carregá-las.
